-- Transaction: A logical unit of work that groups one or more SQL operations into a single execution block, where either all operations succeed together or all are rolled back — ensuring the database stays in a consistent state
-- ACID features:
/*
Atomicity
